...
class CommonFunctions:
    ...
    def getLocationFromPathAndDist(self, Xmeters, first=Location, second=Location):
        d = Xmeters
        R = 6370000
        brng = self.getBearing(first, second) #azimut? aka ktorym smerom ist?
        ...
        newLocation.setAltitude(first.getAltitude()) #CHANGE get a setHeight to get a set Altitude
        return newLocation
    ...
    def getShortestDistanceFromLocations(self, locations, point=Location): #point is point on map nothing special here
        shortest = 9999999.9
