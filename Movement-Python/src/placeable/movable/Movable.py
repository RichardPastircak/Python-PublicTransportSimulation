...
class Movable(Placeable):
    def __init__(self, locationsTable, map, name):
        super(Movable, self).__init__(locationsTable, map, name)
        self.activityQueue = []
        self.com = CommonFunctions()
        self.locationLog = ""
        self.previousTarget = None

    def setActivityQueue(self, newValue):
        self.activityQueue = newValue
