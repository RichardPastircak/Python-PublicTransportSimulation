// var map = L.map('map', {center: [49.001831, 21.239311], zoom: 12}), //15 normalally, carrefull its quite sensitive
var map = L.map('map', {center: [49.001831, 21.239311], zoom: 14}), //15 normalally, carrefull its quite sensitive,
